package dev.aeld.sga.cliente.jpql;
...
public class PruebaJPQL {
    ...
    public static void main(String[] args) {
        ...
        log.debug("\n4. Consulta de datos individuals, se crea un arreglo (tupla) de tipo object de 3 columnas");
        ...
        jpql = "select new dev.aeld.sga.domain.Persona( p.idPersona ) from Persona p";
        personas = em.createQuery(jpql).getResultList();
        //mostrarPersonas(personas);
        ...
        log.debug("\n13. Uso de order by");
        jpql = "select p from Persona p where p.idPersona > 2 order by p.nombre, p.apellido desc";
        personas = em.createQuery(jpql).getResultList();
        //mostrarPersonas(personas);
