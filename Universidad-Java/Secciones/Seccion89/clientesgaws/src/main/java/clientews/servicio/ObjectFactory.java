...
public class ObjectFactory {
    ...
    private final static QName _ListarPersona_QNAME = new QName("http://servicio.sga.aeld.dev/", "listarPersona");
    private final static QName _ListarPersonaResponse_QNAME = new QName("http://servicio.sga.aeld.dev/", "listarPersonaResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://servicio.sga.aeld.dev/", name = "listarPersona")
     ...
     */
    @XmlElementDecl(namespace = "http://servicio.sga.aeld.dev/", name = "listarPersonaResponse")
