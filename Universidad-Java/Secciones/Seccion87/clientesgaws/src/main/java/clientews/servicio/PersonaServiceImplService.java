 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.sga.aeld.dev/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.sga.aeld.dev/", "PersonaServiceImplService");
    ...
    public PersonaServiceWs getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.sga.aeld.dev/", "PersonaServiceImplPort"), PersonaServiceWs.class);
    }
    ...
    public PersonaServiceWs getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.sga.aeld.dev/", "PersonaServiceImplPort"), PersonaServiceWs.class, features);
    }
